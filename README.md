...
<!-- AUTO: snapshot:START -->
*Last Automatic Update Time: 2026-08-08* · 数据快照 **807** 项（322 curated + 2 新发现）
<!-- AUTO: snapshot:END -->
...
| 4 | [cjnum](https://gitcode.com/Cangjie-SIG/cjnum) | 386 | 9 | Cangjie | 0 | 这是一个用于 Cangjie 语言的数值计算库，提供了广泛的数学、科学计算和数值分析功能。 | 2026-05-22 |
| 5 | [tree-sitter-cangjie](https://gitcode.com/Cangjie-SIG/tree-sitter-cangjie) | 375 | 5 | C | 2 |  | 2026-07-30 |
| 6 | [fountain](https://gitcode.com/Cangjie-SIG/fountain) | 372 | 59 | Cangjie | 0 | 一个用于服务器应用开发的综合工具库。  - 零配置文件 - 环境变量和命令行参数配置 - 约定优于配置 - 深刻利用仓颉语言特性 - 只需要开发动态链接库，fboot负责加载... | 2026-08-07 |
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [CJASTHelper](https://gitcode.com/Cangjie-SIG/CJASTHelper) | 389 | 4 | C++ | 6 | Cangjie Abstract Syntax Tree Helper | 2026-07-13 |
...
| 5 | [intellij-cangjie](https://gitcode.com/Cangjie-SIG/intellij-cangjie) | 35 | 1 | Kotlin | 0 | Intellij Platform 仓颉语言插件 | 2026-08-08 |
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [cjnum](https://gitcode.com/Cangjie-SIG/cjnum) | 386 | 9 | Cangjie | 0 | 这是一个用于 Cangjie 语言的数值计算库，提供了广泛的数学、科学计算和数值分析功能。 | 2026-05-22 |
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [fountain](https://gitcode.com/Cangjie-SIG/fountain) | 372 | 59 | Cangjie | 0 | 一个用于服务器应用开发的综合工具库。  - 零配置文件 - 环境变量和命令行参数配置 - 约定优于配置 - 深刻利用仓颉语言特性 - 只需要开发动态链接库，fboot负责加载... | 2026-08-07 |
...
| 5 | [cli-cj](https://gitcode.com/Cangjie-SIG/cli-cj) | 23 | 1 | Cangjie | 0 |  | 2026-08-08 |
...
| 2 | [cjbind](https://gitcode.com/Cangjie-TPC/cjbind) | 41 | 2 | Cangjie | 1 | 这是 https://github.com/cjbind/cjbind 的只读镜像 | 2026-08-08 |
| 3 | [Cjson](https://gitcode.com/Cangjie-TPC/CJson) | 39 | 9 | Cangjie | 6 | Json 序列化/反序列化工具，自动给被标记的类增加fromJson()和toJson()等方法，使其自身具备序列化/反序列化能力 | 2026-07-21 |
