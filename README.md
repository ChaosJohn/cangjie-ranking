...
<!-- AUTO: snapshot:START -->
*Last Automatic Update Time: 2026-08-15* · 数据快照 **817** 项（322 curated + 0 新发现）
<!-- AUTO: snapshot:END -->
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [CangjieMagic](https://gitcode.com/Cangjie-TPC/CangjieMagic) | 1172 | 78 | Cangjie | 17 | 基于仓颉编程语言构建的 LLM Agent DSL，其主要特点包括：声明式 DSL、支持 MCP 协议，支持任务智能规划等。 | 2026-05-27 |
...
| 3 | [CJASTHelper](https://gitcode.com/Cangjie-SIG/CJASTHelper) | 485 | 4 | C++ | 6 | Cangjie Abstract Syntax Tree Helper | 2026-07-13 |
| 4 | [cjnum](https://gitcode.com/Cangjie-SIG/cjnum) | 483 | 9 | Cangjie | 0 | 这是一个用于 Cangjie 语言的数值计算库，提供了广泛的数学、科学计算和数值分析功能。 | 2026-05-22 |
| 5 | [tree-sitter-cangjie](https://gitcode.com/Cangjie-SIG/tree-sitter-cangjie) | 471 | 5 | C | 2 |  | 2026-07-30 |
...
| 7 | [TPC-Test-Framework](https://gitcode.com/Cangjie-TPC/TPC-Test-Framework) | 373 | 1 | Python | 10 | 仓颉用例执行脚本 | 2026-07-16 |
...
| 2 | [CangjieMagic](https://gitcode.com/Cangjie-TPC/CangjieMagic) | 1172 | 78 | Cangjie | 17 | 基于仓颉编程语言构建的 LLM Agent DSL，其主要特点包括：声明式 DSL、支持 MCP 协议，支持任务智能规划等。 | 2026-05-27 |
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [CJASTHelper](https://gitcode.com/Cangjie-SIG/CJASTHelper) | 485 | 4 | C++ | 6 | Cangjie Abstract Syntax Tree Helper | 2026-07-13 |
| 2 | [tree-sitter-cangjie](https://gitcode.com/Cangjie-SIG/tree-sitter-cangjie) | 471 | 5 | C | 2 |  | 2026-07-30 |
...
| 5 | [intellij-cangjie](https://gitcode.com/Cangjie-SIG/intellij-cangjie) | 35 | 1 | Kotlin | 0 | Intellij Platform 仓颉语言插件 | 2026-08-15 |
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [cjnum](https://gitcode.com/Cangjie-SIG/cjnum) | 483 | 9 | Cangjie | 0 | 这是一个用于 Cangjie 语言的数值计算库，提供了广泛的数学、科学计算和数值分析功能。 | 2026-05-22 |
...
| 5 | [cli-cj](https://gitcode.com/Cangjie-SIG/cli-cj) | 24 | 1 | Cangjie | 0 |  | 2026-08-15 |
...
| 2 | [cjbind](https://gitcode.com/Cangjie-TPC/cjbind) | 41 | 2 | Cangjie | 1 | 这是 https://github.com/cjbind/cjbind 的只读镜像 | 2026-08-15 |
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [TPC-Test-Framework](https://gitcode.com/Cangjie-TPC/TPC-Test-Framework) | 373 | 1 | Python | 10 | 仓颉用例执行脚本 | 2026-07-16 |
