...
<!-- AUTO: snapshot:START -->
*Last Automatic Update Time: 2026-09-18* · 数据快照 **896** 项（322 curated + 0 新发现）
<!-- AUTO: snapshot:END -->
...
| 6 | [fountain](https://gitcode.com/Cangjie-SIG/fountain) | 820 | 60 | Cangjie | 1 | 一个用于服务器应用开发的综合工具库。  - 零配置文件 - 环境变量和命令行参数配置 - 约定优于配置 - 深刻利用仓颉语言特性 - 只需要开发动态链接库，fboot负责加载... | 2026-09-18 |
...
| 5 | [intellij-cangjie](https://gitcode.com/Cangjie-SIG/intellij-cangjie) | 877 | 2 | Kotlin | 2 | Intellij Platform 仓颉语言插件 | 2026-09-18 |
