...
<!-- AUTO: snapshot:START -->
*Last Automatic Update Time: 2026-09-21* · 数据快照 **898** 项（322 curated + 2 新发现）
<!-- AUTO: snapshot:END -->
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [cjgrapht](https://gitcode.com/Cangjie-SIG/cjgrapht) | 838 | 96 | Cangjie | 0 | 一个图论数据结构和算法库，提供多种图结构以及图算法。 | 2025-07-04 |
| 2 | [CangjieMagic](https://gitcode.com/Cangjie-TPC/CangjieMagic) | 1746 | 78 | Cangjie | 18 | 基于仓颉编程语言构建的 LLM Agent DSL，其主要特点包括：声明式 DSL、支持 MCP 协议，支持任务智能规划等。 | 2026-05-27 |
