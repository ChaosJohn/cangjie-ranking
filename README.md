...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [CangjieMagic](https://gitcode.com/Cangjie-TPC/CangjieMagic) | 1174 | 78 | Cangjie | 17 | 基于仓颉编程语言构建的 LLM Agent DSL，其主要特点包括：声明式 DSL、支持 MCP 协议，支持任务智能规划等。 | 2026-05-27 |
...
| 3 | [CJASTHelper](https://gitcode.com/Cangjie-SIG/CJASTHelper) | 486 | 4 | C++ | 6 | Cangjie Abstract Syntax Tree Helper | 2026-07-13 |
| 4 | [cjnum](https://gitcode.com/Cangjie-SIG/cjnum) | 484 | 9 | Cangjie | 0 | 这是一个用于 Cangjie 语言的数值计算库，提供了广泛的数学、科学计算和数值分析功能。 | 2026-05-22 |
| 5 | [tree-sitter-cangjie](https://gitcode.com/Cangjie-SIG/tree-sitter-cangjie) | 472 | 5 | C | 2 |  | 2026-07-30 |
| 6 | [TPC-Test-Framework](https://gitcode.com/Cangjie-TPC/TPC-Test-Framework) | 374 | 1 | Python | 10 | 仓颉用例执行脚本 | 2026-07-16 |
| 7 | [fountain](https://gitcode.com/Cangjie-SIG/fountain) | 374 | 60 | Cangjie | 1 | 一个用于服务器应用开发的综合工具库。  - 零配置文件 - 环境变量和命令行参数配置 - 约定优于配置 - 深刻利用仓颉语言特性 - 只需要开发动态链接库，fboot负责加载... | 2026-08-16 |
...
| 9 | [ACEHarness](https://gitcode.com/Cangjie-SIG/ACEHarness) | 170 | 67 | TSX | 7 | 重构你的Agent生产力 \| Your team of AI | 2026-08-15 |
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [CJASTHelper](https://gitcode.com/Cangjie-SIG/CJASTHelper) | 486 | 4 | C++ | 6 | Cangjie Abstract Syntax Tree Helper | 2026-07-13 |
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [cjnum](https://gitcode.com/Cangjie-SIG/cjnum) | 484 | 9 | Cangjie | 0 | 这是一个用于 Cangjie 语言的数值计算库，提供了广泛的数学、科学计算和数值分析功能。 | 2026-05-22 |
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [fountain](https://gitcode.com/Cangjie-SIG/fountain) | 374 | 60 | Cangjie | 1 | 一个用于服务器应用开发的综合工具库。  - 零配置文件 - 环境变量和命令行参数配置 - 约定优于配置 - 深刻利用仓颉语言特性 - 只需要开发动态链接库，fboot负责加载... | 2026-08-16 |
...
| Ranking | Project Name | Stars | Forks | Language | Open Issues | Description | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [TPC-Test-Framework](https://gitcode.com/Cangjie-TPC/TPC-Test-Framework) | 374 | 1 | Python | 10 | 仓颉用例执行脚本 | 2026-07-16 |
